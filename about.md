...
I’m a software engineer based in Colombia _(not Columbia)_ with more than 8 years of experience. I work remotely as a C# backend engineer. I specialize in building APIs and backend code with .NET technologies. Mainly ASP.NET Core, ASP.NET Web API, and SQL Server these days.
...
In my free time, I like to read books _(on paper)_ and learn _(foreign)_ languages. 
