...
On August 27th, 1997 the world as we knew it changed.

Skynet became self-aware.

That was almost 30 years ago. Maybe Terminator 2 wasn't just a movie, but a documentary. Who knows? But while we wait for nuclear destruction, humanity's extinction, or simply _Universal Basic Income_, here's my statement on how I use AI:
...
That's why I don't recommend [new coders rely on AI]({% post_url 2025-09-15-ShouldIUseAI %}) to generate code, but use it as a learning aid. And that's also why I've put some rules:

1. [AI stays outside my editor]({% post_url 2025-10-14-AIRule %})
2. [Use AI with oversight]({% post_url 2026-01-26-AnotherAIRule %})

I don't swear by AI. [It's far away from replacing coders]({% post_url 2025-04-25-WillAITakeMyJob %}). But [coding will look different in 10 years]({% post_url 2024-04-29-2034Predictions %}). Well, it already look different.
...
I'm in the _"if you don't care to write them, why should I care to read them?"_ team. We don't need another AI-generated post starting with "In today's world..."
