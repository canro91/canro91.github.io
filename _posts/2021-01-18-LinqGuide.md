...
We grouped our list of movies using only one property: `Rating`. But, [GroupBy has other use-cases]({% post_url 2022-05-30-HowToUseLinqGroupBy %}): transforming each group and grouping by more than one property.
