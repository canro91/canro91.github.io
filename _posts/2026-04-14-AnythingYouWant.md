...
To stop answering the same questions, he wrote Anything You Want. You could notice [his take on succint writing and short books]({% post_url 2026-04-04-DerekSivers %}).

Here are 10 lessons I learned from reading it—I'm practicing [the 10-idea list habit]({% post_url 2025-06-22-SimplerNoteTaking %}) and [the 7-word summary]({% post_url 2026-01-25-7Words %}):
...
**#4. Share something people want and charge for it.** Starting [a business doesn't have to be complicated]({% post_url 2026-03-20-Entrepreneurship %}) after all.
...
**#8. Always think about your clients.** Make them happy, even [when asking for favors]({% post_url 2026-04-12-Pizzas %}).

**#9. Every confusing word makes you lose money.** That applies for your website, emails, and every piece of copy. [Rejecting sales calls]({% post_url 2025-02-10-SellingWithoutCalls %}) makes you clarify your message.
