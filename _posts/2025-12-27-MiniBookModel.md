...
For so long, writing a book felt distant: original ideas, months of research, and plenty of rejections. Then I discovered self-publishing had redefined [what a book could be]({% post_url 2025-04-22-BookForGrandkids %}). And finally, Chris Stanley debunked those objections with [the concept of a mini book]({% post_url 2025-10-07-MiniBooks %}).

After attending one of Chris' workshops last year, I devoured his book, _Mini Book Model_. Here are 7 lessons I learned:
...
Apart from a problem and solution, after [launching Street-Smart Coding]({% post_url 2025-11-16-LaunchingABook %}), I learned to write a book description and [a one-line summary]({% post_url 2025-11-09-OneLine %}) before the content. That forces you to clarify your message.
...
That's what Chris did with the whole _Mini Book_ series. The first book, _Mini Book Model_ introduces what a mini book is and how to write one. Then he wrote another mini book about each step in the process.
...
I've embraced mini books in the coding space, and you can [find my mini books here](https://imcsarag.gumroad.com/?utm_source=blog&utm_medium=post&utm_campaign=lessons-mini-book-model).
