...
Last month, I started [reducing my phone time]({% post_url 2026-01-22-LessScrolling %}). To [embrace boredom]({% post_url 2026-02-03-Boredom %}), I schedule a "Nothing" slot away from tech.
...
When he started his writing career, he didn't know how to use a typewriter. And later when he injured one of his hands, he kept the habit. At least, that's what [his biopic]({% post_url 2025-07-28-Chespirito %}) shows.

## It's extra work, but here's what I'm doing less

For [my February book experiment]({% post_url 2026-02-01-BookExperiment %}), I wrote the last two chapters by hand.
