...
This week, I averaged 2h39min on my phone. Today, it was 1h55min. I just checked it. That's enough to [produce some creative work]({% post_url 2025-12-30-TwoHours %}).
...
For that, I'm putting [my phone out of sight]({% post_url 2024-12-13-KeepingPhonesAround %}), in a new place.

And in every place where I used to put my phone, I'm leaving a book and a zine instead.

This week, a rabbit hole took me to [Austen Kleon's rules of reading](https://austinkleon.substack.com/p/read-like-an-artist-db7). He made a zine, a tiny magazine with eight pages created from a single sheet of paper.
...
If you want to follow along, here are [the books I read last year]({% post_url 2025-12-31-Books %}). Perfect replacements for where your phone used to sit.
