...
I wrote the roadmap I wish I had at the start of my coding journey. I had written [mini-books]({% post_url 2025-10-07-MiniBooks %}) before, but this one was different. It pushed my writing and marketing skills, and my self-discipline.

[Writing taught me lessons]({% post_url 2025-09-22-WritingABook %}), but launching was a whole different game.

Here's what I've learned:

**#1. Set an artificial deadline.** To keep yourself focused, set a launch day. Pick a day and mark it on your calendar. Also share it with everyone involved in your book: [beta readers]({% post_url 2025-10-09-BetaReaders %}), designers, editors...

**#2. Start with a promise, title, and outline.** Before writing the actual content, start with the sales page or the Amazon description. It forces you to clarify your message. And to make the promotion phase easier, come up with [a one-liner to explain your book]({% post_url 2025-11-09-OneLine %}).
...
[I could have finished in half the time]({% post_url 2025-10-04-ABookFaster %}) by focusing on one commitment. I only started to see progress when I focused on my book and let all other projects suffer. It's really easy to lose momentum with a book.
...
Being [a fan of writing 10-idea lists]({% post_url 2025-06-17-TenIdeas %}), I used 10-idea lists for every step of the process:
* 10 title ideas
* 10 chapter ideas
