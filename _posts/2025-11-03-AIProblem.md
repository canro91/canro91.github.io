---
layout: post
title: "The Real Problem With AI Writing All Our Code"
tags: coding
---

AI might promise speed and productivity. But it comes with serious issues.

The other day I found [a senior coder quitting AI coding]({% post_url 2025-10-20-SloppyAI %}) after finding out that:
...
After experimenting with AI, I realized [I was becoming lazier than usual]({% post_url 2025-07-13-TheProblemWithAI %}). Since then, [I've set simple rules]({% post_url 2025-10-14-AIRule %}) to avoid losing my skills.

But those aren't the biggest problems.

## A failed experiment revealed a more serious problem

Today I found out about [the experiment of a team of coders](https://dev.to/veith-octomind/why-agents-do-not-write-most-of-our-code-a-reality-check-87j) that revealed a deeper problem.

After trying to write a feature at work only by prompting, they realized:

> _[Even when AI is capable of writing all of our code], a huge issue remains: I lose my mental model of the codebase._
> ...
> _Until I can trust the AI completely, I need to keep my own mental model alive. Otherwise, every time I need to do something myself feels like joining a new company._
