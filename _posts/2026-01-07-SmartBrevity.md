---
layout: post
title: "Six Lessons to Say More With Fewer Words—Using Smart Brevity"
tags: books writing
---
...
Deliver fast. Say more with fewer words. That's the big idea behind _Smart Brevity,_ the digital version of the classic _Elements of Style_.
...
* Use key phrases to guide skimmers. Phrases like _"why this matters,"_ _"the big picture,"_ or _"backstory."_

In [Mastery]({% post_url 2026-01-03-Mastery %}), Robert Greene used "Understand" to introduce big ideas. That's a visual clue for skimmers.

**#3. The bar & beach test.** Write like a human. Don't use any word you wouldn't use in a bar or on the beach. No more _"Dear LinkedIn network, I'm pleased to announce..."_

**#4. The "would you read it?" test.** Once you're done, ask yourself: _"Would I read it if I hadn't written it?"_ If not, why do you think someone else will?
...
**#6. For presentations:**
* Start and end with _"if you remember one thing from this, ..."_
