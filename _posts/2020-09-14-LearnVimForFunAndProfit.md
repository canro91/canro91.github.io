...
![Macro typewriter ribbon](https://source.unsplash.com/AgQaMOQFWeA/800x400)
...
A common task while programming and editing text in general is to copy and paste. Vim can copy and paste too. Well, how do we copy and paste with Vim? Vim calls these actions _yank_ and _put_.
