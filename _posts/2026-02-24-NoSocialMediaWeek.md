...
1. Noticing my phone time. 2h18min on average the week before.
2. Finding a post inviting people to disappear from the Internet without apologies, announcements, or guilt. I did that—kind of.
...
Ignoring [my own productivity advice]({% post_url 2025-07-16-ProductivityTips %}), I checked my email and socials before work.

When [planning my feed-free week]({% post_url 2026-02-15-NoFeeds %}), I thought I needed an app/website blocker. But starting [the first day]({% post_url 2026-02-16-NoFeeds1 %}) with an intention was enough. _"No social media today."_

Instead of scrolling, I read.

That week, I finished [Papyrus by Irene Vallejo]({% post_url 2026-02-22-Papyrus %}) and got halfway through Financial Freedom by Grant Sabatier. In fact, I've been [replacing my phone time]({% post_url 2026-01-22-LessScrolling %}) with books in the last month.
...
[On day two]({% post_url 2026-02-17-NoFeeds2 %}), I was on a weekly meeting with a contracting client. "Another meeting that could be an email" kind of meeting. Nothing unusual until I noticed I wanted to fire up my LinkedIn account to make it until the end. I wanted a feed to scroll, like an addict.
...
1. No email notifications from social media.
2. Zero feeds before creative work. Timer on socials for conscious use.
3. Weekly posts scheduled in advance. Have 2 or 3 weekly slots for engagement.
4. Feed-free mode when working on creative projects or experiments.

I thought I wasn't an addict. I thought I used [social media consciously]({% post_url 2026-01-19-LinkedIn %}). I thought I was a dealer who didn't use their own drug. Stepping away showed me I was just another dopamine junkie. Social media, like every billion-dollar industry, thrives on keeping us hooked.
