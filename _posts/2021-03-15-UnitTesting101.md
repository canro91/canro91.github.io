...
The `TestClass` and `TestMethod` attributes belong to a project called MSTest. [Microsoft Test Framework (MSTest)](https://github.com/microsoft/testfx) is an open-source unit testing framework. MSTest comes installed with Visual Studio.
