---
layout: post
title: "7 Random But Interesting Ideas I Found Last Week"
tags: misc
---

_Recently, I've started to list interesting ideas I found over the week—to practice [my 10-idea list habit]({% post_url 2025-06-17-TenIdeas %}). Here are 7 from the last week._

**#1. The Matthew effect.**
Inspired by a verse from the gospel of Matthew, recognition goes to already-recognized people.
[Visit social media]({% post_url 2026-01-19-LinkedIn %}) and you'll see it.
...
When reading for insight, [make it active]({% post_url 2025-06-22-SimplerNoteTaking %}).
Otherwise, you won't remember anything.

**#4. Solve the problem with what's in your room.**
Or [in your head or in your notes]({% post_url 2026-04-28-YourRoomAndHead %}).
...
_[Writing a 10-idea list changed my life]({% post_url 2026-03-04-10SimpleIdeas %}). Try it! It could change yours too._
